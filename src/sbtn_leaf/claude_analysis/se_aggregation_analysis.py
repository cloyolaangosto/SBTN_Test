...
def _write_findings(path: Path, coverage, focal_summary, variance, n_maps) -> None:
    ...
    lines.append(
        ...
        "`sbtn_leaf.claude_analysis.se_aggregation_analysis.run_full_analysis()` and embedded in "
        "`paper/claude_analysis/SoilErosion_Aggregation_Comparison.ipynb`); they are not "
